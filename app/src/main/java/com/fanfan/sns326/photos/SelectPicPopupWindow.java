...
public class SelectPicPopupWindow extends PopupWindow {
	...
	public SelectPicPopupWindow(Context context, OnClickListener itemsOnClick) {
		...
		takePhotoBtn = (Button) mMenuView.findViewById(R.id.item_popupwindows_camera);
		pickPhotoBtn = (Button) mMenuView.findViewById(R.id.item_popupwindows_Photo);
		cancelBtn = (Button) mMenuView.findViewById(R.id.item_popupwindows_cancel);
		// 设置按钮监听
